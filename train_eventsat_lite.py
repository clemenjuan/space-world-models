"""Full Lightning training loop for the EventSat-Lite macro-action LeWM model."""
...
@hydra.main(version_base=None, config_path="./config/train", config_name="eventsat_lite")
def run(cfg):
    configure_utf8_stdio()
    patch_pyarrow_for_legacy_datasets()
    stub_lance_if_no_avx()
