...
from swm_eventsat.data.toy_eventsat_env import ACTION_DIM, MODE_LIST, STATE_NAMES, EventSatEnv, heuristic_eventsat_policy
...
def evaluate(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "learning_target": "VectorJEPA latent dynamics: predict next latent observation embedding from recent observations and one-hot actions",
        "action_rules": [
